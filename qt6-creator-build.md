...
% mv doc deleted
% mv scripts deleted
% mv src/shared/cpaster ~/src/qt-creator-deleted/src
% mv src/shared/designerintegrationv2 ~/src/qt-creator-deleted/src/sh
% mkdir ~/src/qt-creator-deleted/src/shared
% mv src/shared/designerintegrationv2 ~/src/qt-creator-deleted/src/shared
% mv src/shared/help/ ~/src/qt-creator-deleted/src/shared
% mv src/shared/json ~/src/qt-creator-deleted/src/shared
% mv src/shared/modeltest ~/src/qt-creator-deleted/src/shared
% mv src/shared/proparser ~/src/qt-creator-deleted/src/shared
% mv src/shared/registryaccess ~/src/qt-creator-deleted/src/shared

% mkdir ~/src/qt-creator-deleted/src/libs/3rdparty
% mv src/libs/3rdparty/cplusplus ~/src/qt-creator-deleted/src/libs/3rdparty
% mv src/libs/3rdparty/json ~/src/qt-creator-deleted/src/libs/3rdparty
% mv src/libs/3rdparty/sqlite ~/src/qt-creator-deleted/src/libs/3rdparty
% mv src/libs/3rdparty/syntax-highlighting ~/src/qt-creator-deleted/src/libs/3rdparty
% mv src/libs/3rdparty/yaml-cpp ~/src/qt-creator-deleted/src/libs/3rdparty

% mv packaging ~/src/qt-creator-deleted
% mv qbs ~/src/qt-creator-deleted
% mv src/shared/pch_files.qbs ~/src/qt-creator-deleted/src/shared
% mv src/src.qbs ~/src/qt-creator-deleted/src

% mv qtcreator.pri ~/src/qt-creator-deleted
% mv qtcreator.qbs ~/src/qt-creator-deleted
% mv qtcreator_ide_branding.pri ~/src/qt-creator-deleted
% mv qtcreator_testvars.pri ~/src/qt-creator-deleted
% mv .tag ~/src/qt-creator-deleted
```
