...
boost_ptree::boost_ptree() : ptree( std::make_unique< boost::property_tree::ptree >() )
{
}

boost_ptree::~boost_ptree()
{
}

bool
boost_ptree::parse( const std::string& json_string )
{
...
std::string
boost_ptree::stringify( bool pritty ) const
{
    std::ostringstream o;
...
std::string
boost_ptree::stringify( const boost::property_tree::ptree& pt, bool pritty )
{
    std::ostringstream o;
