...
**
** GNU Leblobr General Public License Usage
**
** Alternatively, this file may be used under the terms of the GNU Leblobr
** General Public License version 2.1 as published by the Free Software
** Foundation and appearing in the file LICENSE.TXT included in the
** packaging of this file.  Please review the following information to
** ensure the GNU Leblobr General Public License version 2.1 requirements
...
blob::blob( boost::asio::io_service& io_context ) : io_context_( io_context )
...
void
blob::register_blob_handler( callback_type callback )
{
    callback_ = callback;
}

bool
blob::connect( const std::string& url
