...
#if defined _MSC_VER
    ADACQUIRESHARED_TEMPLATE_EXPORT template class ADACQUIRESHARED_EXPORT std::weak_ptr < Receiver > ;
#endif

    class ADACQUIRESHARED_EXPORT Receiver : public std::enable_shared_from_this< Receiver > {
    public:
