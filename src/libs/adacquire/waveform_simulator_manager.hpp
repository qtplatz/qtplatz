...
namespace adacquire {
...
#if defined _MSC_VER
	ADACQUIRESHARED_TEMPLATE_EXPORT template class ADACQUIRESHARED_EXPORT std::function < std::shared_ptr< adacquire::waveform_simulator >( double, double, uint32_t, uint32_t ) > ;
#endif
    class ADACQUIRESHARED_EXPORT waveform_simulator_manager {
		...
		std::function< std::shared_ptr< adacquire::waveform_simulator >( double, double, uint32_t, uint32_t ) > factory_;
    ...
    public:
        ...
        std::shared_ptr< adacquire::waveform_simulator >
