...
////// ColorMap matrix<double>
    ...
    QImage imfilter< QImage, imContours >::operator()<>( const boost::numeric::ublas::matrix< double >& m, double scaleFactor ) const
    {
        ...
        if ( method.sizeFactor() > 1 )
            cv::resize( mat, mat, cv::Size(0,0), method.sizeFactor(), method.sizeFactor(), cv::INTER_LINEAR );
        ...
        return adcv::transform_< QImage >()( drawing );
    }

#ifdef WIN32
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale >::imfilter() : size_( 1 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap >::imfilter() : size_( 1 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imBlur >::imfilter() : size_( 2 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imBlur >::imfilter( imGrayScale a, imBlur b ) : size_( 2 ), algos_( a, b ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imBlur >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imDFT >::imfilter() : size_( 2 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imDFT >::imfilter( imGrayScale a, imDFT b ) : size_( 2 ), algos_( a, b ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imDFT >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imBlur >::imfilter() : size_( 2 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imBlur >::imfilter( imColorMap a, imBlur b ) : size_( 2 ), algos_( a, b ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imBlur >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imDFT >::imfilter() : size_( 2 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imDFT >::imfilter( imColorMap a, imDFT b ) : size_( 2 ), algos_( a, b ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imDFT >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imDFT, imBlur >::imfilter() : size_( 3 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imDFT, imBlur >::imfilter( imColorMap a, imDFT b, imBlur c )
        : size_( 3 ), algos_( a, b, c ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imColorMap, imDFT, imBlur >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imDFT, imBlur >::imfilter() : size_( 3 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imDFT, imBlur >::imfilter( imGrayScale a, imDFT b, imBlur c )
        : size_( 3 ), algos_( a, b, c ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imGrayScale, imDFT, imBlur >::~imfilter() {}

    template<> ADCVSHARED_EXPORT imfilter< QImage, imContours >::imfilter() : size_( 1 ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imContours >::imfilter( imContours a ) : size_( 1 ), algos_( a ) {}
    template<> ADCVSHARED_EXPORT imfilter< QImage, imContours >::~imfilter() {}
