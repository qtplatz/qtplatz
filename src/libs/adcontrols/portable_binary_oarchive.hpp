...
// variable being loaded
    ...
    class ADCONTROLSSHARED_EXPORT portable_binary_oarchive_exception;
    class ADCONTROLSSHARED_EXPORT portable_binary_oarchive;
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE( adcontrols::portable_binary_oarchive)
#endif

    // required by export in boost <= 1.34
#define BOOST_ARCHIVE_CUSTOM_OARCHIVE_TYPES adcontrols::portable_binary_oarchive
