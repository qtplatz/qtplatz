...
// variable being loaded
    ...
    class ADCONTROLSSHARED_EXPORT portable_binary_iarchive_exception;    
    class ADCONTROLSSHARED_EXPORT portable_binary_iarchive;
...
// 17, Aug, 2014 --toshi
    ...
    protected:
        ...
        std::wstring wstring( const std::string& );
        void debug_break();
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE( adcontrols::portable_binary_iarchive )
#endif
