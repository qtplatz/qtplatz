...
namespace adcontrols {
    namespace ControlMethod {
        ...
        private:
            ...
            friend ADCONTROLSSHARED_EXPORT void tag_invoke( const boost::json::value_from_tag, boost::json::value&, const TimedEvent& );
        ...
        void tag_invoke( const boost::json::value_from_tag, boost::json::value&, const TimedEvent& );

        ADCONTROLSSHARED_EXPORT
        TimedEvent tag_invoke( const boost::json::value_to_tag< TimedEvent >&, const boost::json::value& jv );
    }
}
