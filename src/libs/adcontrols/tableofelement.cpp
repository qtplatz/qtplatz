...
// The ultimate source of accurate masses and isotope values are IUPAC and CAWIA (Commission on Atomic Weights and Isotopic Abundances)
// for a list of the latest corrected values please see Pure Appl. Chem., Vol. 75, No. 6, pp. 683–800, 2003
// the recommended values A(r) should be included into accurate mass calculators including corrections for positive and negative charges
// depending on ionization type (odd or even electron).
...
namespace adcontrols {
    namespace detail {
        ...
        static struct element {
            ...
            { "H",   "Hydrogen",       1,   1,  2,  { { 1.00782503207,        0.999885 },          // m(proton+e-)
