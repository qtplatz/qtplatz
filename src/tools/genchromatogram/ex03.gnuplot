set terminal epslatex size 11.7,8.3*0.5 in color colortext standalone header \
...
plot '< ' . EXEC . " --resolution=2 --noise=100.0" using 1:2 with lines lw 5 lc "black" notitle
#plot 'ex03.txt' using 1:2 with lines lw 5 notitle
