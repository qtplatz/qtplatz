...
#include <adwidgets/consolewidget.hpp>
...
#ifdef Q_WS_MAC
const QString rsrcPath = ":/eventtool/images/mac";
#else
const QString rsrcPath = ":/eventtool/images/win";
#endif
                                        ...
                                        , timer_(new QTimer(this))
{
    ...
    eventtool::document::instance()->initialSetup();
...
{
    eventtool::document::instance()->finalClose();
