                                           ...
                                           , zoomReset_( 250 )
{
    ...
    zoomInIcon->setIcon(QPixmap(":/cluster/images/zoomin.png"));
    zoomInIcon->setIconSize(iconSize);
    QToolButton *zoomOutIcon = new QToolButton;
    zoomOutIcon->setAutoRepeat(true);
    zoomOutIcon->setAutoRepeatInterval(33);
    zoomOutIcon->setAutoRepeatDelay(0);
    zoomOutIcon->setIcon(QPixmap(":/cluster/images/zoomout.png"));
    zoomOutIcon->setIconSize(iconSize);
    zoomSlider_ = new QSlider;
    zoomSlider_->setMinimum(0);
    zoomSlider_->setMaximum(1000);
    zoomSlider_->setValue( zoomReset_ );
    ...
    rotateLeftIcon->setIcon(QPixmap(":/cluster/images/rotateleft.png"));
    rotateLeftIcon->setIconSize(iconSize);
    QToolButton *rotateRightIcon = new QToolButton;
    rotateRightIcon->setIcon(QPixmap(":/cluster/images/rotateright.png"));
    ...
    printButton_->setIcon(QIcon(QPixmap(":/cluster/images/fileprint.png")));

    for ( auto name: { "Gray", "Log", "Logging" } ) {
        if ( auto btn = new QToolButton ) {
            btn->setText( name );
            btn->setObjectName( name );
            labelLayout->addWidget( btn );
    ...
    for ( auto name: { "DFT", "RAW", "0-Fill", "Blur", "Contours" } ) {
        if ( auto btn = new QToolButton ) {
            btn->setText( name );
            btn->setObjectName( name );
            btn->setCheckable(true);
...
ImageView::setImage( const cv::Mat& m )
{
    ...
    case CV_32F:
        raw_ = m;
        cv::cvtColor( cluster::cvColor()( m ), mat_, cv::COLOR_BGR2RGB );
        break;
    }
...
void
ImageView::setChecked( const QString& name, bool checked )
{
    if ( auto btn = findChild< QToolButton * >( name ) ) {
