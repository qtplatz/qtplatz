...
namespace cluster {
    ...
    private:
        ...
        void __initializeHistogramMethodForm();
    ...
    private slots :
        ...
        void handleOpen();
        void handleFrameChanged( double timeSinceInject, uint64_t trigNumber, uint64_t trigCounts );
        void handleTofTimeRange( int, const QRectF& );
    };
