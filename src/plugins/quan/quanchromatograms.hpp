...
namespace quan {
    ...
    public:
        ...
        // QuanChromatograms& operator << ( const std::tuple< std::tuple< std::formula, double, int /* charge */ >, double double >& );
        ...
        void identify_cpeak( const adcontrols::QuanCompounds *, std::shared_ptr< const adcontrols::ProcessMethod > pm );
