...
namespace quan {
    ...
    class QuanExportProcessor : public adcontrols::dataSubscriber {
        QuanExportProcessor( const QuanExportProcessor& ) = delete;
        QuanExportProcessor& operator = (const QuanExportProcessor&) = delete;
    public:
        ~QuanExportProcessor();

        QuanExportProcessor( QuanProcessor *
