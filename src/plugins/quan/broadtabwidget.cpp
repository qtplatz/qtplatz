...
BroadTabWidget::~BroadTabWidget()
{
}

BroadTabWidget::BroadTabWidget(QWidget *parent) : QWidget(parent)
                                                ...
                                                , lastVisibleIndex_(-1)
{
    setObjectName( QStringLiteral("quan__BroadTabWidget") );
    resize( 800, 400 );
...
int
BroadTabWidget::currentIndex() const
{
    return currentIndex_;
}

void
BroadTabWidget::setCurrentIndex(int index)
{
...
int
BroadTabWidget::currentSubIndex() const
{
...
void BroadTabWidget::setTitle(const QString &title)
{
    title_ = title;
    update();
}
...
QSize
BroadTabWidget::minimumSizeHint() const
{
    return QSize(0, Utils::StyleHelper::navigationWidgetHeight() + OTHER_HEIGHT + 1);
}

void
BroadTabWidget::updateNameIsUniqueAdd(Tab *tab)
{
...
void
BroadTabWidget::updateNameIsUniqueRemove(const Tab &tab)
{
    if (tab.nameIsUnique)
        return;
    int index;
...
void
BroadTabWidget::addTab(const QString &name, const QString &fullName, const QStringList &subTabs)
{
    Tab tab;
    tab.name = name;
...
void
BroadTabWidget::insertTab(int index, const QString &name, const QString &fullName, const QStringList &subTabs)
{
    Tab tab;
    tab.name = name;
    tab.fullName = fullName;
...
void
BroadTabWidget::removeTab(int index)
{
...
QPair<BroadTabWidget::HitArea, int>
BroadTabWidget::convertPosToTab(QPoint pos)
{
...
void
BroadTabWidget::mousePressEvent(QMouseEvent *event)
{
    // todo:
...
void
BroadTabWidget::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
bool
BroadTabWidget::event(QEvent *event)
{
