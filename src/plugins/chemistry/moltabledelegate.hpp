...
namespace chemistry {
    ...
    class MolTableDelegate : public QItemDelegate {
        Q_OBJECT
    public:
        explicit MolTableDelegate(QObject *parent = 0);
    ...
    private:
        void render_svg( QPainter *, const QRect&, const QPalette&, const QByteArray& ) const;
    };

}

//Q_DECLARE_METATYPE( chemistry::process );
