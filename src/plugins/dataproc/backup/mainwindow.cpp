...
MainWindow::createStyledBarTop()
{
    ...
    if ( toolBar ) {
        ...
        if ( am ) {
            ...
            globalcontext.add( Core::Id( Core::Constants::C_GLOBAL ) );
...
MainWindow::createStyledBarMiddle()
{
    ...
    if ( toolBar2 ) {
        ...
        if ( am ) {
            ...
            context.add( Core::Id( Core::Constants::C_GLOBAL ) );
...
QWidget *
MainWindow::createContents( Core::IMode * mode, const std::wstring& apppath )
{
...
MainWindow::currentDir()
{
    ...
    QString currentFile = Core::DocumentManager::currentFile(); // Core::ICore::instance()->documentManager()->currentFile();
