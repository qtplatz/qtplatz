...
//    }
    ...
    do {
        ...
        dataprocFactory_.reset( new DataprocessorFactory( this, mTypes ) );
        addAutoReleasedObject( dataprocFactory_.get() );
    } while ( 0 );
    ...
    QWidget * widget = mainWindow_->createContents( mode_.get(), apppath );
...
Q_EXPORT_PLUGIN2(Dataproc, DataprocPlugin)
