...
ContourWnd::ContourWnd(QWidget *parent) : QWidget(parent)
...
void
ContourWnd::handlePrintCurrentView( const QString& pdfname )
{
...
void
ContourWnd::handleSessionAdded( Dataprocessor* )
{
}

void
ContourWnd::handleProcessed( Dataprocessor* processor, portfolio::Folium& folium )
{
    handleSelectionChanged( processor, folium );
}

void
ContourWnd::handleSelectionChanged( Dataprocessor*, portfolio::Folium& folium )
{
...
void
ContourWnd::handleApplyMethod( const adcontrols::ProcessMethod& )
{
}

void
ContourWnd::handleCheckStateChanged( Dataprocessor*, portfolio::Folium&, bool )
{
}

void
ContourWnd::handleSelected( const QPointF& pos )
{
    double w = 0.001;
