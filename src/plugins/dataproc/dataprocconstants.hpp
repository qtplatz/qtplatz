...
namespace Constants {
    ...
    const wchar_t * const F_MSLOCK             = adcontrols::constants::F_MSLOCK;
    ...
    const char * const GRP_MERGE_FILES      = "MergeFiles";
    const char * const GRP_SELECTION_EXPORT = "SelectionExportToFiles";
