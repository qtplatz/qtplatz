...
// Contexts
const int  C_GLOBAL_ID             = 0; // to be deleted
...
const char * const OPEN_IN_EXTERNAL_EDITOR = "QtCreator.OpenInExternalEditor"; // to be deleted
