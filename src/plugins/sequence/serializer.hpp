...
namespace sequence {
    ...
    public:
        ...
        static bool restore( std::shared_ptr<ControlMethod::Method>&, const std::vector<char>& );
        ...
        static bool restore( std::shared_ptr<adcontrols::ProcessMethod>&, const std::vector<char>& );

        static bool archive( adfs::detail::cpio&, const ControlMethod::Method& );
        static bool restore( std::shared_ptr< ControlMethod::Method>&, const adfs::detail::cpio& );
    };
