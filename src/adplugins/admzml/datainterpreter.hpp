...
namespace mzml {
    ...
    using spectrum_t = std::variant< std::shared_ptr< mzml::mzMLSpectrum >
                                     >;
    ...
    public:
        ...
        adcontrols::translate_state
        translate( spectrum_t& variant, const int8_t * data, size_t dsize, const int8_t * meta, size_t msize ) {
