...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:key name="qm-search" match="wix:Component[not(contains(wix:File/@Source, '.qm'))]" use="@Id" />

  <!-- exclude !.qm -->
  <xsl:template match="wix:Component[key('qm-search', @Id)]" />
  <xsl:template match="wix:ComponentRef[key('qm-search', @Id)]" />
