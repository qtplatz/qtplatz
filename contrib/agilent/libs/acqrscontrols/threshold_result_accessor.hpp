...
namespace acqrscontrols {
    ...
    public:
        ...
        std::optional< std::pair< uint64_t, uint64_t > > pos_range() const override;
    ...
    template< typename T >
    class ACQRSCONTROLSSHARED_EXPORT threshold_result_accessor_ : public adacquire::SignalObserver::DataAccess {
