...
namespace acqrscontrols {
    ...
    namespace u5303a {
        ...
        // uuid needs to be matched to 'adcontrols::DataInterpreterBroker::name_to_uuid()' value, a.k.a. uuids::name_generator( master_observer.baseid )( xxx_observer_name );
        ...
        constexpr boost::uuids::uuid pkd_observer        = {{ 0xd1, 0x15, 0x62, 0x0a, 0xbe, 0x64, 0x53, 0x7c, 0xb2, 0xba, 0xd4, 0xa0, 0x47, 0x3f, 0x8b, 0x6a }}; // u5303a pkd
