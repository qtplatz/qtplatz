...
namespace u5303acontrols {
    ...
    template<> U5303ACONTROLSSHARED_EXPORT void metadata::serialize( boost::archive::xml_woarchive& ar, unsigned int version )
    {
        metadata_archive<>().serialize( ar, *this, version );
    }

    template<> U5303ACONTROLSSHARED_EXPORT void metadata::serialize( boost::archive::xml_wiarchive& ar, unsigned int version )
    {
        metadata_archive<>().serialize( ar, *this, version );
    }

    template<> U5303ACONTROLSSHARED_EXPORT void metadata::serialize( portable_binary_oarchive& ar, unsigned int version )
    {
        metadata_archive<>().serialize( ar, *this, version );
    }

    template<> U5303ACONTROLSSHARED_EXPORT void metadata::serialize( portable_binary_iarchive& ar, unsigned int version )
    {
        metadata_archive<>().serialize( ar, *this, version );
    }    
}

using namespace u5303acontrols;
