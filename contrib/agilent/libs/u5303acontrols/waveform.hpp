...
namespace u5303acontrols { class method; class threshold_result; }
...
#if defined _MSC_VER
    class waveform;
    U5303ACONTROLSSHARED_TEMPLATE_EXPORT template class U5303ACONTROLSSHARED_EXPORT std::weak_ptr < waveform > ;
#endif

	class U5303ACONTROLSSHARED_EXPORT waveform : public std::enable_shared_from_this< waveform > {
...
#pragma warning(pop)
    ...
    //template<> U5303ACONTROLSSHARED_EXPORT const int16_t * waveform::begin() const;
    //template<> U5303ACONTROLSSHARED_EXPORT const int16_t * waveform::end() const;
    //template<> U5303ACONTROLSSHARED_EXPORT const int32_t * waveform::begin() const;
    //template<> U5303ACONTROLSSHARED_EXPORT const int32_t * waveform::end() const;
