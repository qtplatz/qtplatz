...
namespace u5303acontrols {
    ...
    template<> U5303ACONTROLSSHARED_EXPORT void device_method::serialize( boost::archive::xml_woarchive& ar, const unsigned int version )
    {
        device_method_archive<>().serialize( ar, *this, version );
    }

    template<> U5303ACONTROLSSHARED_EXPORT void device_method::serialize( boost::archive::xml_wiarchive& ar, const unsigned int version )
    {
        device_method_archive<>().serialize( ar, *this, version );
    }
