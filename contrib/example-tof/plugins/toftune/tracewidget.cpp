...
#include <adwplot/plotcurve.hpp>
#include <adwplot/annotation.hpp>
#include <adwplot/annotations.hpp>
...
void
TraceWidget::setData( const adcontrols::MassSpectrum& ms, int idx, bool yaxis2 )
{
    using tracewidget::TraceData;
...
using namespace hmqtune::tracewidget;
...
void
TraceWidgetImpl::update_annotations( Dataplot& plot
