...
namespace tofspectrometer {
    ...
    class tof : public adcontrols::MassSpectrometer
    ...
    public:
		...
		const adcontrols::MassSpectrometer::ScanLaw& getScanLaw() const override;
    ...
    private:
        ...
        adcontrols::MassSpectrometer::ScanLaw * scanLaw_;
