...
datareader_factory::accept( adplugin::visitor& visitor, const char * adplugin )
{
    ...
    auto factory = []( const char * traceid ) {
        return std::make_shared< lrp_ex::data_reader >( traceid );
    };

    adcontrols::DataReader::register_factory( factory, lrp_ex::data_reader::__objtext__().c_str(), lrp_ex::data_reader::__objuuid__() );
