...
namespace infitofwidgets { class nLapDialog; }
namespace adwidgets { class Progress; }

namespace infitofprocessor {
    
    class INFITOFPROCESSORSHARED_EXPORT nLapDeconv {
    public:
        nLapDeconv();
        ~nLapDeconv();
    ...
    private:
        void initialSetup( std::shared_ptr< adprocessor::dataprocessor >, infitofwidgets::nLapDialog& );
    };
