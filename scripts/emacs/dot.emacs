...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (mozc org-journal gnuplot use-package cmake-font-lock cmake-ide cmake-mode company vhdl-tools company-irony-c-headers company-irony egg git gnuplot-mode dts-mode cuda-mode mozc-im langtool flycheck-rtags company-rtags ac-mozc))))
(custom-set-faces
